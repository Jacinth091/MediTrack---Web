...
const childVariants = {
  ...
  return (
   <div className='grid grid-cols-2 min-h-[80vh] font-sans'>
      {/* <div style={{ width: '100%', height: '600px', position: 'relative' }}>
        <DarkVeil />
      </div> */}
    <motion.div className='flex flex-col justify-center p-12 text-left space-y-6  ml-24'
     initial="initial"
      animate="animate"
      variants={containerVariants}
    >
      <h1 className='text-5xl font-bold font-sans text-gray-900 leading-tight'>
      ...
      <p className='text-xl font-light text-gray-600 leading-relaxed'>
        The First Blockchain-Encrypted, patient-centric platform that unifies your entire medical journey – across hospitals, labs, and pharmacies – in one click. Unlike traditional EHRs, MediTrack gives you zero-trust encrypted control over who accesses your records – with military-grade security and private keys you hold.
            ...
            <h1 className='font-serif'>Your health, our priority</h1>
    ...
    <motion.div className='flex justify-start items-center ml-10'
     initial="initial"
      animate="animate"
